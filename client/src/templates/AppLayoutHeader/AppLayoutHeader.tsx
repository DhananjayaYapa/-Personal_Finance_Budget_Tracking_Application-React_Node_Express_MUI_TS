...
const ROUTE_META: Record<string, { title: string; breadcrumb: string }> = {
  ...
  [APP_ROUTES.TRANSACTIONS]: { title: 'Transactions', breadcrumb: 'Transactions' },
  [APP_ROUTES.CATEGORIES]: { title: 'Categories', breadcrumb: 'Categories' },
  [APP_ROUTES.BUDGETS]: { title: 'Budgets', breadcrumb: 'Budgets' },
